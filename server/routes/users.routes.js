...
router.patch("/api/add-task",passport.authenticate('jwt', {session:false}), userCtrl.addTask);
router.patch("/api/edit-task/:id",passport.authenticate('jwt', {session:false}), userCtrl.editTask);
router.patch("/api/delete-task/:id",passport.authenticate('jwt', {session:false}), userCtrl.deleteTask);
